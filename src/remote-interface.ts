...
<body>
  <!-- Header -->
  <header class="header">
    <h1><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:-5px;margin-right:10px;color:var(--accent)"><rect x="5" y="4" width="16" height="15" rx="2"/><line x1="9" y1="8" x2="16" y2="8" opacity="0.45"/><line x1="9" y1="11.5" x2="18" y2="11.5"/><line x1="9" y1="15" x2="14" y2="15" opacity="0.45"/><path d="M1.5 11.5 L4.5 9.8 L4.5 13.2 Z" fill="currentColor" stroke="none"/></svg>Teleprompter Remote</h1>
